        ...
        <div className="clinic_container">
          <div className="clinic_info">
            ...
            <div className="basic_info" id="info_02">
              ...
              <p>
                Наши доступные цены заставили тысячи людей улыбнуться новой, красивой, неотразимой улыбкой, какой еще никогда не было!!
              </p>
              <HashLink
                to={"/#contact-us"}
                style={{ textDecoration: "none", color: "#fff" }}
            ...
            <div className="basic_info" id="info_03">
              ...
              <p>
                ...
                Воскресенье: с 17.00 до 10.00 после полудня
              </p>
